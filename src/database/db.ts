...
-- =====================================================
-- 3. TABLE CONDITIONNEMENTS
-- =====================================================
CREATE TABLE IF NOT EXISTS conditionnements (
  idConditionnement INTEGER PRIMARY KEY AUTOINCREMENT,
  idProduit INTEGER NOT NULL,
  code_conditionnement TEXT NOT NULL,
  libelle TEXT NOT NULL,
  quantite_unites REAL NOT NULL,
  prix_vente REAL NOT NULL,
  est_actif INTEGER DEFAULT 1,
  FOREIGN KEY (idProduit) REFERENCES products(idProduit) ON DELETE CASCADE
);
...
-- =====================================================
-- 13. TABLE CONFIGURATION ATELIER
-- =====================================================
